...
namespace {
    ...
    MOVE_VERTEX, MOVE_VERTEX2, DEL_ISOLATE,
	...
	// followed by input file name
{
	...
	while (iarg < argc && argv[iarg][0] == '-') {
		...
		case USE_D:
			io_info.flag_use_collapse_D= true;
			break;
    ...
    case RANDOM_NUM_INTERVALS_PARAM:
      iarg++;
			if (iarg >= argc) usage_error();
			io_info.random_num_intervals = atoi(argv[iarg]);
			break;
